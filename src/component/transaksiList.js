                ...
                <div className="sm-12">
                    <div className="card-body row">
                        <div className="col-lg-4 col-sm-12">
                            <small className="text-info">Customer <BsIcons.BsFillPeopleFill/></small>
                            <h6>{this.props.customer_name}</h6>
                        </div>
                        <div className="col-lg-3 col-sm-12">
                            <small className="text-info">Address <FaIcons.FaMapMarkerAlt /></small>
                            <h6>{this.props.customer_address}</h6>
                        </div>
                        <div className="col-lg-2 col-sm-12">
                            <small className="text-info">Total Amount <BsIcons.BsFillCalculatorFill /></small>
